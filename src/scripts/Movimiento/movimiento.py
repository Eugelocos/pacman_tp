...
def manejar_movimiento(entidad, escena, delta_time=1):
    ...
    es_pared_siguiente_dir=_es_pared_siguiente(centro_gxy, entidad.proxima_direccion, escena)
    if not es_pared_siguiente_dir:
        ...
        if alineado:     
            ...
            direccion = direccion_aplicar



    es_pared=_es_pared_siguiente(centro_gxy, direccion_aplicar, escena)
    if es_pared:
        alineado=False
...
def _es_pared_siguiente(centro_gxy, direccion_aplicar, escena):
    grilla=escena.game_manager.grid_manager
